         ...
         <div id="all">
            <div id="header">
               <table>
                  <tr>
                     <td id="header1">
                        <a href="exe.cute?action=goToHome" id="CatalogDefaultHeaderLink">Home<img border="" src=""/>
                        </a>
                     </td>
                     <td id="header2">
                        <span id="CatalogDefaultHeaderTitle">FREETEXT</span>
                     </td>
                     <td id="header3">
                        <ul id="CatalogDefaultMainMenu">
                           <li id="CatalogDefaultMainMenuItem1">ITEM<a href="exe.cute?action=goToSeller" id="CatalogDefaultMainMenuItem1SellerLink">Seller</a>
                           </li>
                           <li id="CatalogDefaultMainMenuItem2">ITEM<a href="exe.cute?action=goToCatalog" id="CatalogDefaultMainMenuItem2CatalogLink">Catalog</a>
                           </li>
                           <li id="CatalogDefaultMainMenuItem3">ITEM<a href="exe.cute?action=goToHome" id="CatalogDefaultMainMenuItem3HomeLink">Home</a>
                           </li>
                        </ul>
                     </td>
                  </tr>
            ...
            <div id="bottom">
               <span id="CatalogDefaultFooter">FREETEXT</span>
            </div>
         </div>
      </body>
   </html>
